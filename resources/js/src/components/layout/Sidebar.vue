                ...
                >
                    <ul class="relative font-semibold space-y-0.5 p-4 py-0">
                        ...
                        <template v-if="authStore.isAdmin">
                            ...
                            <li class="nav-item">
                                <router-link to="/quickbooks/executive" class="group" @click="toggleMobileMenu">
                                    <div class="flex items-center">
                                        <svg class="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M3 3v18h18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path opacity="0.5" d="M7 15l4-4 3 3 5-6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                        <span class="ltr:pl-3 rtl:pr-3 font-normal text-black text-base">Executive Dashboard</span>
                                    </div>
                                </router-link>
                            </li>
                            <li class="nav-item">
                                <router-link to="/quickbooks/cash-flow" class="group" @click="toggleMobileMenu">
                                    <div class="flex items-center">
                                        <svg class="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M3 12a9 9 0 1018 0 9 9 0 00-18 0z" stroke="currentColor" stroke-width="1.5"/>
                                            <path opacity="0.5" d="M12 7v5l3 2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                        <span class="ltr:pl-3 rtl:pr-3 font-normal text-black text-base">Cash Flow</span>
                                    </div>
                                </router-link>
                            </li>
                            <li class="nav-item">
                                <router-link to="/quickbooks/profitability" class="group" @click="toggleMobileMenu">
                                    <div class="flex items-center">
                                        <svg class="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M4 19h16M6 15l3-4 3 2 4-6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                        <span class="ltr:pl-3 rtl:pr-3 font-normal text-black text-base">Profitability</span>
                                    </div>
                                </router-link>
                            </li>
                            <li class="nav-item">
                                <router-link to="/quickbooks/customers-collections" class="group" @click="toggleMobileMenu">
                                    <div class="flex items-center">
                                        <svg class="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.768-.231-1.48-.634-2.071M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.768.231-1.48.634-2.071M15 7a3 3 0 11-6 0 3 3 0 016 0z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                        </svg>
                                        <span class="ltr:pl-3 rtl:pr-3 font-normal text-black text-base">Customers &amp; Collections</span>
                                    </div>
                                </router-link>
                            </li>
                            <li class="nav-item">
                                <router-link to="/quickbooks/invoices-bills" class="group" @click="toggleMobileMenu">
                                    <div class="flex items-center">
                                        <svg class="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <span class="ltr:pl-3 rtl:pr-3 font-normal text-black text-base">Invoices &amp; Bills</span>
                                    </div>
                                </router-link>
                            </li>
                            <li class="nav-item">
                                <router-link to="/quickbooks/expenses-vendors" class="group" @click="toggleMobileMenu">
                                    <div class="flex items-center">
                                        <svg class="group-hover:!text-primary shrink-0" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <span class="ltr:pl-3 rtl:pr-3 font-normal text-black text-base">Expenses &amp; Vendors</span>
                                    </div>
                                </router-link>
                            </li>
                            <li class="nav-item">
                 ...
                 a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                        ...
                        <template v-else>
                            ...
                            <li class="nav-item">
                                <router-link to="/ai-chat" class="group" @click="toggleMobileMenu">
                                    <div class="flex items-center">
