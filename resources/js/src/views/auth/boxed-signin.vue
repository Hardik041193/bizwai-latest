                    ...
                    <div class="mx-auto w-full max-w-[440px]">
                        ...
                        <form class="space-y-5 dark:text-white" @submit.prevent="handleLogin">
                            <div v-if="authStore.error" class="rounded-md px-4 py-3 text-sm"
                                :class="authStore.requiresVerification ? 'bg-warning/10 border border-warning/30 text-warning' : 'bg-danger/10 border border-danger/30 text-danger'">
                                {{ authStore.error }}
                        ...
                        <div class="mt-4 text-center">
                            <router-link to="/auth/admin-login" class="inline-flex items-center gap-1.5 text-xs text-white-dark transition hover:text-primary">
                                <svg class="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                                </svg>
                                Administrator? Sign in to Admin Portal
                            </router-link>
                        </div>
                    </div>
                </div>
